          ...
          <form onSubmit={handleSubmit}>
                      ...
                      <div className="absolute inset-0 bg-on-surface/0 group-hover:bg-on-surface/30 transition-colors flex items-center justify-center">
                        <div className="opacity-0 group-hover:opacity-100 transition-opacity flex gap-3">
                          <button
                            ...
                            className="p-3 rounded-full bg-surface/90 text-on-surface hover:bg-surface transition-colors"
                          ...
                          <button
                            ...
                            className="p-3 rounded-full bg-surface/90 text-error-lajoy hover:bg-error-container transition-colors"
                      ...
                      <div key={i} className="flex gap-4 items-center">
                        ...
                        {ingredients.length > 1 && (
                          <button
                            ...
                            className="text-outline-variant/40 hover:text-error-lajoy transition-colors"
                  ...
                  <div className="space-y-8">
                    {instructions.map((step, i) => (
                      <div key={i} className="flex gap-6">
                        <span className="font-heading text-primary-fixed-dim text-3xl italic opacity-50">
                        ...
                        <div className="flex-grow flex gap-2">
                          ...
                          {instructions.length > 1 && (
                            <button
                              ...
                              className="text-outline-variant/40 hover:text-error-lajoy transition-colors shrink-0 self-start mt-6"
            ...
            <div className="mt-20 pt-10 border-t border-outline-variant/20 flex flex-col md:flex-row justify-between items-center gap-6">
              <button
                ...
                className="font-label text-xs uppercase tracking-[0.2em] text-on-surface-variant hover:text-error-lajoy transition-colors flex items-center gap-2"
              >
